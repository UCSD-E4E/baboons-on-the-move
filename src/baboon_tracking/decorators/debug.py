...
class DisplayDebugRegions(Stage):
    ...
    def execute(self) -> StageResult:
        if not self._data_attribute_map:
            ...
            for data_stage in DisplayDebugRegions.stage_debug_map:
        ...
        for data_stage, data_attributes in self._data_attribute_map.items():
            for data_attribute in data_attributes:
                ...
                for debug_stage, _ in debug_stage_list:
...
def debug(frame_mixin: Callable, color: Tuple[int, int, int]):
    def inner_function(function: Callable):
        ...
        def on_init(self):
            ...
            DisplayDebugRegions.stage_debug_map[most_recent_mixin].append((self, color))
